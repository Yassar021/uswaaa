    ...
    <main className="flex flex-col items-center px-20 overflow-hidden pt-28 pb-7 bg-zinc-100 max-md:px-5 max-md:pt-24">
      <div className="flex flex-col items-start ml-5 w-full max-w-[1161px] max-md:max-w-full">
            ...
            <div className="flex flex-col w-[58%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow max-md:mt-10 max-md:max-w-full">
                ...
                <div className="text-3xl leading-9 tracking-tighter mt-14 text-zinc-600 max-md:mt-10 max-md:max-w-full">
                  Whether it's about geomatics, research, or just a friendly
                  chat, I’d love to hear from you. Your thoughts matter! Let’s
        ...
        >
          ...
          <a
            href="mailto:uswatunhasanahrahman@gmail.com"
        ...
        <motion.footer
          ...
          whileInView="show"
          id="contact"
          className="flex flex-wrap items-start justify-between w-full gap-5 px-px py-1 my-8 text-xl font-medium leading-6 tracking-tighter max-md:mt-10 max-md:max-w-full"
        >
          <div className="text-indigo-800">Uswatun Hasanah ⏤ 2025</div>
